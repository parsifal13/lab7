 ...
 *
 * <p>
 * Description: This class will represent a single playing card that has a value
 * between 1 and 13 and a suit (Clubs, Diamonds, Hearts or Spades). A card can
 * return its value, suit, point value or reference to a String containing the
 * card�s value and suit. It can check to see if two cards have the same value
 * or the same suit.
 * </p>
 *
...
public class Card {
     ...
     * card -- 11 if Ace is high, 1 if Ace is low, 10 for a face card, the
     * actual value for cards 2 through 10
     * 
     * @param aceHigh
